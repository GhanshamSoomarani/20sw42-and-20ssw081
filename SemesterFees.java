...
public class SemesterFees  extends JFrame implements ActionListener
{
        JPanel headpanel,panel1,buttonpanel,buttonpanel1,accadimicInformation,accadmic1,detail,detail2,detail3;
        JFrame frame;
        JTextField tf1, tf2,tf3, tf4, tf5,tf6,tf7,tf8;
        JButton homebtn,applybtn, loginbtn,calbtn,feebtn,save$close,sub,hostelafee,hostelsfee,admissionFees;
        ...
        SemesterFees(){
            ...
            fees.setText("Tuition fee                                 fee(Per Semester)      14000.00"+"\n"+
                     "Games                                          (Per Semester)            500.00"+"\n"+
                     "Developmental charges              (Per Semester)           1000.00"+"\n"+
