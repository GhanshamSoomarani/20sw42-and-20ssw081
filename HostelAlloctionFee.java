...
public class HostelAlloctionFee  extends JFrame implements ActionListener
{
        JPanel headpanel,panel1,buttonpanel,buttonpanel1,accadimicInformation,accadmic1,detail,detail2,detail3;
        JFrame frame;
        JTextField tf1, tf2,tf3, tf4, tf5,tf6,tf7,tf8;
        JButton homebtn,applybtn, loginbtn,calbtn,feebtn,save$close,sub,hostelafee,hostelsfee,admissionFees,semfee;
        ...
        HostelAlloctionFee(){
            ...
            admissionFees = new JButton("Admission Fees");
            admissionFees.setFont(new Font("Arial black.",Font.BOLD,25)); 
            admissionFees.setBounds(100,160, 300, 50);
            panel1.add(admissionFees);
            admissionFees.addActionListener(this);
            ...
            semfee.setBounds(700,160, 300, 50);
            panel1.add(semfee);
            ...
            fees.setText("Admission fee                                     (Once)               5000.00"+"\n"+
                     "Room deposit                          (Refundable-Once)        2500.00"+"\n"+
                     "Allotment Processing fee                   (Once)                 500.00"+"\n"+
                     "Transport charges                       (Per Semester)           5000.00"+"\n"+
                     "Examination Fee                          (Per Semester)           2000.00"+"\n"+
