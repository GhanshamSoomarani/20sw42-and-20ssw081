...
public class HostelSemesterFees  extends JFrame implements ActionListener
{
        JPanel headpanel,panel1,buttonpanel,buttonpanel1,accadimicInformation,accadmic1,detail,detail2,detail3;
        JFrame frame;
        JTextField tf1, tf2,tf3, tf4, tf5,tf6,tf7,tf8;
        JButton homebtn,applybtn, loginbtn,calbtn,feebtn,save$close,sub,hostelafee,semfee,admissionFees;
        ...
        HostelSemesterFees(){
            ...
            semfee.setBounds(400,160, 300, 50);
            panel1.add(semfee);
            ...
            fees.setText("Sport charges                            (Per Semester)            500.00"+"\n"+
                     "Medical charges                       (Per Semester)           500.00"+"\n"+
                     "Room charges                          (Per Semester)           6000.00"+"\n"+
                     "Utility Charge                            (Per Semester)           2000.00"+"\n"+
                     "Hostel Identity Card Fee            (Per Semester)           200.00"+"\n"+
                     "Total:                                                                            9200.00");
